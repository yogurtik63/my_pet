...
class PetCreatePage extends StatefulWidget {
  ...
  PetCreatePage({super.key, required this.title, required this.pet, required this.callbackParent, required this.callbackMain});
...
class _PetCreatePageState extends State<PetCreatePage> {
  ...
  late String _selectedAnimal = getAnimalTypeStr(pet.animalType) != "" ? getAnimalTypeStr(pet.animalType) : "Кот";
                        ...
                        Column(
                            ...
                            children: [
                              ...
                              DropdownButton<String>(
                                items: <String>['Собака', 'Кот', 'Попугай', 'Хомяк'].map((String value) {
