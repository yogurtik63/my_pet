...
class FinanceCreatePage extends StatefulWidget {
  ...
  FinanceCreatePage({super.key, required this.callbackParent});
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  const VerticalDivider(width: 32, color: Color.fromRGBO(0, 0, 0, 0)),
                                  DropdownButton<String>(
                                    items: <String>['Лекарства', 'Игрушки', 'Корм', 'Другое'].map((String value) {
